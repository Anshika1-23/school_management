...
<div id="app">
    <div id="main">
        ...
        @component('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard','Document Info'=>'admin/doc-info']])
            @slot('title') Add Document Info @endslot
            @slot('add_btn') <a href="{{url('admin/document-info/create')}}" class="btn btn-sm btn-primary">Add New</a> @endslot
