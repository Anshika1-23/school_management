...
<div id="app">
    <div id="main">
        ...
        @component('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard']])
            ...
            @slot('active') Section  @endslot
        @endcomponent
        <!-- /.content-header -->
        <!-- show data table component -->
        <div class="page-content">
            @component('admin.components.data-table',['thead'=>
            ['S NO.','Section','Status','Action']
            ])
            @slot('table_id') section-list @endslot
            @endcomponent
        </div>
        <!--login form Modal -->
                    ...
                    <form id="addSection" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="Section" name="title" class="form-control">
                            </div>
                        </div>
...
<script type="text/javascript">
    var table = $("#section-list").DataTable({
        processing: true,
        serverSide: true,
        ajax: "sections",
        columns: [
