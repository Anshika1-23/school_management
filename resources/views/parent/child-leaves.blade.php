    ...
    <div id="main" class="layout-horizontal">
        ...
        <div class="content-wrapper container">
            <div class="page-heading">
                <h3 class="d-inline">{{$student->full_name}} Leaves</h3>
                                ...
                                <form id="add_parentLeave" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <input type="date" placeholder="Enter Date" value="{{date('Y-m-d')}}" name="applyDate" class="form-control">
                                        </div>
                                        <input type="text" hidden name="std_id" value="{{$student->id}}">
                                        <div class="form-group">
