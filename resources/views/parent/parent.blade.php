...
<body>
            ...
            <div class="row match-height me-0">
                <div class="col-lg-4 mx-auto">
                    <div class="card">
                        ...
                        <h4 class="text-center">PARENT LOGIN</h4>
                        <div class="card-content">
                            <div class="card-body">
                                <form id="parentLogin" class="position-relative" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
    ...
    <script src="{{asset('assets/js/parent-login.js')}}"></script>
    <input type="hidden" class="parent-url" value="{{url('parent')}}">
</body>
</html>