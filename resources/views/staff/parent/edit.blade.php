...
<div id="app">
    <div id="main">
        ...
        @component('staff.components.content-header',['breadcrumb'=>['Dashboard'=>'staff/dashboard','Parent'=>'staff/parents']])
        ...
        <section id="multiple-column-form">
            <form id="editParent" method="POST" enctype="multipart/form-data" data-parsley-validate>
                ...
                {{ method_field('PUT') }}
                @if($parent)
                    <input type="hidden" class="url" value="{{url('staff/parents/'.$parent->id)}}">
