            ...
            <div class="page-content">
                <section class="row">
                    ...
                    @component('admin.components.data-table',['thead'=>
                        ['S NO.','Type','From','To','Apply Date','Status','Action']
                    ])
                    ...
                    <div class="modal fade text-left" id="modal-default" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                            ...
                            <div class="modal-content">
                                ...
                                <form id="add_studentLeave" method="POST">
                                    @csrf
                                    <input type="hidden" class="url" value="{{url('student/leaves')}}" >
                    ...
                    <!--login form Modal -->
                    <div class="modal fade text-left" id="stdview-applyLeave" tabindex="-1" role="dialog"
                        aria-labelledby="myModalLabel33" aria-hidden="true">
